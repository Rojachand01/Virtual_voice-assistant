...
def wishme():
    ...
    speak("Myself jarvis! How may I help you sir") #BotName - Give a name to your assistant
...
def play():
    ...
    while True:
        ...
        if 'exit' in query:
        ...
        elif 'namaskar doston' in query:
            var.set('namaskar sir')
            window.update()
            speak("namsakar sir")
        ...
        elif  'how do you feel interact with me' in query:
            var.set('awesome sir')
            window.update()
            speak("awesome sir")
            ...
            var.set('My Creator is Human Being')
            window.update()
            speak('My Creator is Human Being')
            ...
            speak("what would like to call me, Sir")
            assname = takeCommand()
            ...
            speak("I am fine how are you mister")
            speak(assname)  
        
        elif "what are you doing" in query:
            speak("i am learning sir,")
            speak("and you sir")

        elif " will you be my gf" in query or "will you be my bf" in query:
            speak("i am note sure about, may be you should give me some time")
